...
BATOCERA_NVIDIA_DRIVER_VERSION_32 = 390.147
BATOCERA_NVIDIA_DRIVER_SUFFIX = $(if $(BR2_aarch64),_64)
BATOCERA_NVIDIA_DRIVER_SUFFIX_32 = $(if $(BR2_armv7l),gnueabihf)
BATOCERA_NVIDIA_DRIVER_SITE = http://download.nvidia.com/XFree86/Linux-aarch64$(BATOCERA_NVIDIA_DRIVER_SUFFIX)/$(BATOCERA_NVIDIA_DRIVER_VERSION)
BATOCERA_NVIDIA_DRIVER_SITE_32 = http://download.nvidia.com/XFree86/Linux-32bit-ARM$(BATOCERA_NVIDIA_DRIVER_SUFFIX_32)/$(BATOCERA_NVIDIA_DRIVER_VERSION_32)
BATOCERA_NVIDIA_DRIVER_SOURCE = NVIDIA-Linux-aarch64$(BATOCERA_NVIDIA_DRIVER_SUFFIX)-$(BATOCERA_NVIDIA_DRIVER_VERSION).run
BATOCERA_NVIDIA_DRIVER_SOURCE_32 = NVIDIA-Linux-armv7l$(BATOCERA_NVIDIA_DRIVER_SUFFIX_32)-$(BATOCERA_NVIDIA_DRIVER_VERSION_32).run
...
define BATOCERA_NVIDIA_DRIVER_VULKANJSON_AARCH64
	$(INSTALL) -D -m 0644 $(@D)/nvidia_icd.json $(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.aarch64.json
        sed -i -e s+'"library_path": "libGLX_nvidia'+'"library_path": "/usr/lib/libGLX_nvidia'+ $(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.aarch64.json
	$(INSTALL) -D -m 0644 $(@D)/nvidia_icd.json $(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.armv7l.json
        sed -i -e s+'"library_path": "libGLX_nvidia'+'"library_path": "/lib32/libGLX_nvidia'+ $(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.armv7l.json
endef

define BATOCERA_NVIDIA_DRIVER_VULKANJSON_ARMV7L
	$(INSTALL) -D -m 0644 $(@D)/nvidia_icd.json $(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.armv7l.json
endef

ifeq ($(BR2_aarch64),y)
	BATOCERA_NVIDIA_DRIVER_POST_INSTALL_TARGET_HOOKS += BATOCERA_NVIDIA_DRIVER_VULKANJSON_AARCH64
endif
ifeq ($(BR2_armv7l),y)
	BATOCERA_NVIDIA_DRIVER_POST_INSTALL_TARGET_HOOKS += BATOCERA_NVIDIA_DRIVER_VULKANJSON_ARMV7L
endif
